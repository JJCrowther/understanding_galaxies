...
figure_save_names = ['smoothness_cut_18_20_{0}_graph_redshift_certain_classification_extended_data.png'.format(cut_threshold), 
                    'smoothness_cut_20_21_{0}_graph_redshift_certain_classification_extended_data.png'.format(cut_threshold),
                    'smoothness_cut_21_24_{0}_graph_redshift_certain_classification_extended_data.png'.format(cut_threshold)]
i=0
